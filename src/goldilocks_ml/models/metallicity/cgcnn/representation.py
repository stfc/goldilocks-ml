...
utilities), © 2024 Science and Technology Facilities Council, CC BY 4.0, and
redistributed under this repository's LICENSE. Layer names and shapes are
fixed by the published metallicity checkpoint.
"""
